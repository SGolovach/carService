...
public class CommentPaginate implements PaginationData<Comment> {
    ...
    public List<Comment> paginate(Map<String, String> requestParam) throws ServiceException {
        ...
        int countPageSession = Integer.parseInt(checkData(requestParam.get(SESSION_COUNT_PAGE)));
        ...
        try {
            ...
            requestParam.put(SESSION_COUNT_PAGE, String.valueOf(countPageSession));
