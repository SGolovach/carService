...
public class UserPaginateTest {
    ...
    public void testPaginate() throws ServiceException {
        List<User> carList = factory.getUserPagination().paginate(paginate);
        assertEquals(carList.size(), 2);
    }

    @Test
    public void testPaginateById() throws ServiceException {
        List<User> carList = factory.getUserPagination().paginateById(paginate,1);
